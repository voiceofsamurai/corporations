...
const openItem = (item) => {
  ...
  openTimeline
    ...
    .addLabel('articleOpening', typeT.in().totalDuration() * 0.75 + openTimeline.labels.typeTransition)
    ...
    .set(
      [item.article.DOM.title, item.article.DOM.number, item.article.DOM.intro, item.article.DOM.description],
      {
        opacity: 0,
        y: '50%',
      },
